...
import { uploadFile, analyzeDataset, confirmClassification } from "../services/api";
...
export default function UploadPage() {
  ...
  const [currentStep, setCurrentStep] = useState('idle'); // idle, uploading, classifying, awaiting_confirmation, selecting_type, preprocessing, complete
  ...
  const handleConfirmClassification = async (overrideType = null) => {
    ...
    setStatusMessage('Applying preprocessing pipeline...');
    ...
    // Simulate preprocessing delay (real preprocessing happens on backend)
        ...
        <Card className="workflow-progress-card">
          ...
          {statusMessage && (
            <div className="workflow-status">
              {(currentStep === 'uploading' || currentStep === 'classifying' || currentStep === 'preprocessing') && (
                <Loader size="small" />
              )}
